...
--  Changes: UUID → VARCHAR(64) (IDENTITY), SESSION_LEG added,
...
CREATE TABLE chat_session (
    session_id   VARCHAR(64)       NOT NULL IDENTITY(1,1),
...
CREATE TABLE mobile_device (
    device_id          VARCHAR(64)       NOT NULL IDENTITY(1,1),
...
CREATE TABLE ucid_mapping (
    ucid_map_id       VARCHAR(64)        NOT NULL IDENTITY(1,1),
    session_id        VARCHAR(64)        NOT NULL,
...
CREATE TABLE session_leg (
    leg_id            VARCHAR(64)        NOT NULL IDENTITY(1,1),
    session_id        VARCHAR(64)        NOT NULL,
...
CREATE TABLE transfer_event (
    transfer_id       VARCHAR(64)        NOT NULL IDENTITY(1,1),
    session_id        VARCHAR(64)        NOT NULL,
    from_leg_id       VARCHAR(64)        NOT NULL,
    to_leg_id         VARCHAR(64)        NULL,
...
CREATE TABLE chat_message (
    message_id   VARCHAR(64)        NOT NULL IDENTITY(1,1),
    session_id   VARCHAR(64)        NOT NULL,
...
CREATE TABLE disconnect_event (
    disconnect_id    VARCHAR(64)        NOT NULL IDENTITY(1,1),
    session_id       VARCHAR(64)        NOT NULL,
...
CREATE TABLE license_event (
    license_event_id  VARCHAR(64)        NOT NULL IDENTITY(1,1),
...
CREATE TABLE leg_disconnect (
    leg_disconnect_id  VARCHAR(64)        NOT NULL IDENTITY(1,1),
    leg_id             VARCHAR(64)        NOT NULL,
    session_id         VARCHAR(64)        NOT NULL,
    participant_type   NVARCHAR(16)  NOT NULL
